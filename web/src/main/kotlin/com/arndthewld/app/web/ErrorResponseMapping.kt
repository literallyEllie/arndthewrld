...
object ErrorExceptionMapping {
    fun register(app: Javalin) {
        ...
        app.exception(Exception::class.java) { e, ctx ->
            Logger.e("Exception occurred for req -> ${ctx.url()}", e)
        ...
        app.exception(BadRequestResponse::class.java) { e, ctx ->
            Logger.w("BadRequestResponse occurred for req -> ${ctx.url()}")
        ...
        app.exception(UnauthorizedResponse::class.java) { e, ctx ->
            Logger.w("UnauthorizedResponse occurred for req -> ${ctx.url()}")
        ...
        app.exception(ForbiddenResponse::class.java) { _, ctx ->
            Logger.w("ForbiddenResponse occurred for req -> ${ctx.url()}")
        ...
        app.exception(HttpResponseException::class.java) { e, ctx ->
            Logger.w("HttpResponseException occurred for req -> ${ctx.url()}")
