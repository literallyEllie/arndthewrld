...
object ModulesConfig {
    private val configModule =
        module {
            ...
            single {
                Google2Client(
                    AppEnvConfig["auth.oauth.platforms.google.key"],
                    AppEnvConfig["auth.oauth.platforms.google.secret"],
                )
            }
